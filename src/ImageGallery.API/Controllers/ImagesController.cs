...
namespace ImageGallery.API.Controllers
{
    ...
    public class ImagesController : ControllerBase
    {
        ...
        {
            // Get user UUID from sub claim.
            // Note, User member of the controller is created from the accessToken in ImageGallery.API.
            var ownerId = User.Claims.FirstOrDefault(c => c.Type == "sub")?.Value;

            // get from repo
            var imagesFromRepo = _galleryRepository.GetImagesByOwner(ownerId);
        ...
        [Authorize("MustOwnImage")] // short form for [Authorize(Policy = "MustOwnImage")]
        ...
        [HttpPost()]
        [Authorize(Roles = "PayingUser")] // validate role claim in the access token.
        public IActionResult CreateImage([FromBody] ImageForCreation imageForCreation)
        {
            ...
            // set image ownerId to login user
            var ownerId = User.Claims.FirstOrDefault(c => c.Type == "sub")?.Value;
